odoo.define('web.TaskSearch', function (require) {
    "use strict";
    ...
    var _t = core._t;
    /**
     * TaskSearch base + general features (applicable to any context)  o_field_invalid
     */
        ...
        _onKeyUpInput: function (e) {
            ...
            if (e.which === $.ui.keyCode.ENTER) {
                ...
                if (regex.test(value)) {
                    var params = {
                        key: value,
                        company_ids: odoo.session_info.user_context.allowed_company_ids,
                    };
                    self._rpc({
