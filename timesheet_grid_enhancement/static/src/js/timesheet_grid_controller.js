odoo.define('timesheet_grid_enhancement.timesheet_grid_controller', function (require) {
    "use strict";

    const gridController = require('timesheet_grid.GridController');
    const utils = require('web.utils');

   const TimesheetGridControllerEnhanced = gridController.extend({
    ...
    return TimesheetGridControllerEnhanced;
});
