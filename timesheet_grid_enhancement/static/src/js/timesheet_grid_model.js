odoo.define('timesheet_grid_enhancement.timesheet_grid_model', function (require) {
    "use strict";

    const TimesheetGridModel = require('timesheet_grid.GridModel');

    const TimesheetGridModelEnhanced = TimesheetGridModel.extend({
        /**
         * @private
         * @param {task} task
         * @returns {str}
    ...
    return TimesheetGridModelEnhanced;
});
