odoo.define('timesheet_grid_sort.timesheet_grid_model', function (require) {
    "use strict";

    const TimesheetGridModel = require('timesheet_grid.GridModel');

    TimesheetGridModel.include({
        /**
         * @private
         * @param {task} task
         * @returns {str}
        ...
        _getLabel: function (task) {
            ...
            if ( task.label.length > 1 ) {
                return task.label[0] + " " + task.label[1]
            }
        ...
        */
        ...
        _fetchUngroupedData: async function (groupBy) {
            ...
            this._gridData.data.forEach((group, groupIndex) => {
                let sortedArrays = this._bubbleSort(group.rows, group.grid, null);
            ...
            this._gridData.totals = this._computeTotals(this._gridData.data[0].grid);
        },
        /**
         * @override
         * @private
